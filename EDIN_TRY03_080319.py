...
plot_dx = np.asarray(loadFile[select_row])
plot_dy = np.asarray(loadFile['Band_6'])
...
# outdata     = driver.Create(output_path, col, row, 1, gdal.GDT_Float64)
...
print(F2020ML.plot_data(plot_dy, plot_dx))
